...
do -- Example UI
	local Window = library:AddWindow("Dansploit - Anime Fighters", {
	...
	do -- Elements
        Tab:AddLabel("Execute The script at %40 loading screen!")
		Tab:AddButton("Unlock Gamepasses", function()
			loadstring(game:HttpGet('https://pastebin.com/raw/pDZ72MPw'))()
		end)
		Tab:AddButton("River Hub (Auto-Farming etc)", function()
			loadstring(game:HttpGet('https://pastebin.com/raw/r7XBXhBg'))()
		end)
		Tab:AddButton("Zero Hub (Key)", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/Discord0000/Zer0Hub/main/MainScript.lua"))()
		end)
        Tab:AddButton("Insane AFS GUI", function()
